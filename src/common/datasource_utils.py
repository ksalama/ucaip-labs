...
def get_training_source_query(
    project, region, dataset_display_name, ml_use="UNASSIGNED", limit=None
):
    """Generates a BigQuery SELECT statement for the training data."""
    ...
    _, bq_dataset_name, bq_table_name = bq_source_uri.replace("bq://", "").split(".")
